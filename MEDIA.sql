...
--
-- Servidor: localhost
-- Tiempo de generación: 31-10-2024 a las 17:47:28
...
(25, 'Ingreso noticias de pruebaasd', '<div>Esto es una noticia de prueba probando los procedimientos de almacenado.</div><div>Actualmente, se actualizo hehe<br></div>asd<br>', NULL, NULL, NULL, 0);
...
--
-- Metadatos para la tabla NOTICIA
--
...
--
-- Metadatos para la base de datos MEDIA
--
COMMIT;
